package com.pupukkaltim.myapplication.fragmentLain;
 ...
 */
public class HargaKomoditasFragment extends Fragment {
    private PDFView pdfViewa;
    private ProgressDialog pDialoga;
    boolean connected = false;

    public HargaKomoditasFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            connected = true;
            new HargaKomoditasFragment.DownloadFileFromURL().execute("https://firebasestorage.googleapis.com/v0/b/pkt-highlight.appspot.com/o/lain%2Fkomoditas.pdf?alt=media&token=e5af4a8b-999e-487d-a089-ac8a3c675c9a");
        }
        else{
            connected = false;
