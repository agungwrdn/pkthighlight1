 ...
 */
public class DownloadDailyFragment extends Fragment {
    private PDFView pdfViewa;
    private ProgressDialog pDialoga;
    boolean connected = false;

    public DownloadDailyFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            connected = true;
            new DownloadDailyFragment.DownloadFileFromURL().execute("https://firebasestorage.googleapis.com/v0/b/pkt-highlight.appspot.com/o/lain%2Fdownload.pdf?alt=media&token=179d2454-8767-45b3-a57b-db015b0be8a1");
        }
        else{
            connected = false;
