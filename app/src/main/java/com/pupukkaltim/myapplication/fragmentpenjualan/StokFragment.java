...
public class StokFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            connected = true;
            new StokFragment.DownloadFileFromURL().execute("https://firebasestorage.googleapis.com/v0/b/pkt-highlight.appspot.com/o/penjualan%2FTonase%20Penjualan.pdf?alt=media&token=b3d2d54a-68c0-40f7-9db2-44d2edd0f2dd");
        }
        else{
            connected = false;
