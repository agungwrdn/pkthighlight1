...
public class HPPFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            connected = true;
            new HPPFragment.DownloadFileFromURL().execute("https://firebasestorage.googleapis.com/v0/b/pkt-highlight.appspot.com/o/keuangan%2Fhpp.pdf?alt=media&token=6c800928-65e5-4ac3-9b5d-91af6e03b7c8");
        }
        else{
            connected = false;
