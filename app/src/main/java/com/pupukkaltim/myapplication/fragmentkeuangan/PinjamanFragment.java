package com.pupukkaltim.myapplication.fragmentkeuangan;
...
public class PinjamanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            connected = true;
            new PinjamanFragment.DownloadFileFromURL().execute("https://firebasestorage.googleapis.com/v0/b/pkt-highlight.appspot.com/o/keuangan%2FPinjaman%20Jangka%20Pendek.pdf?alt=media&token=af11b42b-c19e-4e10-be55-6102f674e4ea");
        }
        else{
            connected = false;
