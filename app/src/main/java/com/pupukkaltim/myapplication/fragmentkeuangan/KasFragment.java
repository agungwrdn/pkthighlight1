...
public class KasFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            connected = true;
            new KasFragment.DownloadFileFromURL().execute("https://firebasestorage.googleapis.com/v0/b/pkt-highlight.appspot.com/o/keuangan%2Fkas.pdf?alt=media&token=ff1855d3-bd37-4967-81d3-53dc07dd91c5");
        }
        else{
            connected = false;
