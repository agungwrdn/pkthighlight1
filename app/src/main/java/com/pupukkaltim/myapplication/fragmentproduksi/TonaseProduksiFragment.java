 ...
 */
public class TonaseProduksiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            connected = true;
            new TonaseProduksiFragment.DownloadFileFromURL().execute("https://firebasestorage.googleapis.com/v0/b/pkt-highlight.appspot.com/o/produksi%2FTonase%20Produksi.pdf?alt=media&token=aaa130f1-ea4e-42d4-957a-001ffb7fbad0");
        }
        else{
            connected = false;
