 ...
 */
public class OnStreamFragment extends Fragment {
    private PDFView pdfViewa;
    private ProgressDialog pDialoga;
    boolean connected = false;

    public OnStreamFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            connected = true;
            new OnStreamFragment.DownloadFileFromURL().execute("https://firebasestorage.googleapis.com/v0/b/pkt-highlight.appspot.com/o/produksi%2FonStream.pdf?alt=media&token=ba6df444-7465-4b01-9f59-a27f0e041cfc");
        }
        else{
            connected = false;
